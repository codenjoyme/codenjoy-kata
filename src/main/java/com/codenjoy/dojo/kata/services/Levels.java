...
public final class Levels {
    ...
    public static final Map<Integer, Class<? extends Level>> COMPLEXITIES = new HashMap<>() {{
        ...
        put(9, SumSquareDifferenceAlgorithm.class);
        put(10, CharOrderAlgorithm.class);
        put(11, NumeralSystemAlgorithm.class);
        put(12, FibonacciNumbersAlgorithm.class);
        put(13, PrimeFactoryAlgorithm.class);

        // TODO split all the descriptions to parts
        put(14, NameIntoInitialsAlgorithm.class);
        put(15, ConcatenatedSquaresAlgorithm.class);
        put(16, HighestAndLowestAlgorithm.class);
        put(17, RemoveVowelsAlgorithm.class);
        put(18, ExesAndOhsAlgorithm.class);
        put(19, IsogramWordsAlgorithm.class);
        put(20, RentCarCostCalculatorAlgorithm.class);
        put(21, DuplicateRemoveAlgorithm.class);
        put(22, ThinkLikeAChildAlgorithm.class);
        put(23, MultiplesThreeOrFiveAlgorithm.class);
        put(24, CreditCardNumberAlgorithm.class);
        put(25, DNASequenceAlgorithm.class);
        put(26, MiddleCharacterAlgorithm.class);
        put(27, NumberOrderAlgorithm.class);
        put(28, Sequence1Algorithm.class);
