...
public class DuplicateRemoveAlgorithm extends AlgorithmLevelImpl {
    ...
    public List<String> getQuestions() {
        return List.of("a",
                ...
                "ddllppppccffmmkkkkjjggggffvvvuaaoooxtttnyyrffbbbbiqqdddd",
                "tnnnnnnnddddccccccckcmkkvvvbbbqqqqddannnnmbbbbsssww",
                "paoooovvviiggggyyyynnnnhhhrjxbbbbbbfjjjjyaaaddqqbbbccueebbbbbbgwoii",
                "ssssiiiijjjwrbbbvvvlllkkkkesssddcnoarrrbbooyyyydssszzzeeewwy",
                "aahhhhvvvviiiiaaabbbbmmmwwwwwzzkkkkyyhhzzzzkkkkcee"
        );
    }
