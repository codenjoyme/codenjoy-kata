...
public class NumeralSystemAlgorithm extends AlgorithmLevelImpl {
    ...
    public List<String> description() {
        return Arrays.asList(
                ...
                "number from one numeral system to another.",

                "Method should accept number, source numeral " +
                "system and target numeral system.",
                
                "Use the spread operator to parse arguments.",
                
                "Don't convert the number to decimal (base 10) first. " +
                "Just convert to target numeral system.",
